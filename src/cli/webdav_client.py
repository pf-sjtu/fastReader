...
class WebDAVClientWrapper:
    ...
    def __init__(self, config, logger: Logger):
        ...
        self.config = config
        self.logger = logger
        self.client: Optional[_WebDAVClient] = None
            ...
            try:
                ...
                if '503' in error_msg:
                    ...
                    if attempt < self.MAX_RETRIES - 1:
                        ...
                        self.logger.warning(f"{operation_name} 失败 (503), {wait_time}秒后重试...")
    ...
    def list_files(self, path: str) -> list[str]:
        ...
        try:
            ...
            # webdav4 的 ls 方法
            files = self.client.ls(path, detail=False)
            # 过滤掉 . 和 ..
        ...
        try:
            ...
            if info:
                return {
                    ...
                    'modified': info.get('modified', '2000-01-01T00:00:00') or '2000-01-01T00:00:00'
                }
            return {}
        except Exception:
            return {}
